  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
       ...
       <div className="bg-blue-100 dark:bg-blue-900/30 border-r-4 border-blue-500 text-blue-700 dark:text-blue-300 p-4" role="alert">
      ...
      <div className="bg-white dark:bg-gray-800 shadow-md rounded-lg overflow-x-auto">
        ...
        {materials.length === 0 && <p className="text-center p-4">لا توجد إدخالات جديدة حالياً.</p>}
      </div>
    </div>
  );
};
