...
function App() {
  ...
  // Background sync and pull mechanism (triggers every 40 seconds; Admin strictly pushes periodically, Viewers pull)
  useEffect(() => {
    const intervalTime = 40 * 1000; // 40 seconds (40,000 ms)
